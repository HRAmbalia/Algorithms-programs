...
// void _dfs(int start, int length, int graph[length][length], int *global_visited) {
//     /*
//         Input: 
...
//             - Another function '_dfs(int start, int length, int graph[length][length], int *global_visited)' is required as helper function for this program
//     */
...
//             _dfs(i, length, graph, global_visited);
//         }
//     }
// }
...
int main() {
    ...
    int visited[4] = {0};
    my_topological_sort_using_dfs(n, graph);
}
